  ...
  return (
    <NavigationWrapper>
     <div className="p-4 pt-[200px]  bg-blue flex flex-col items-center gap-5">
      <h1 className="text-3xl   md:text-[60px]  max-w-[1000px] text-center md:leading-[60px] text-white font-bold mb-4">{situation.header}</h1>
      <p className='text-white max-w-[600px] text-center text-base md:text-[20px] '>{situation.content}</p>
      <HeroForm/>
     </div>
