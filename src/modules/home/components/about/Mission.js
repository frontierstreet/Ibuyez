			...
			<div>
				...
				<div className="flex flex-col md:flex-row items-center  justify-between gap-5 md:gap-10 mb-5 relative">
					<p className="text-normal flex-1 text-[16px] mt-4 leading-[28.03px] md:text-[18px] md:leading-[32px] 950:text-[20px] 950:leading-[38.4px]">
						In 2014, we set out to reinvent life’s most important transaction with a
						new, simple way to buy and sell a home. We’ve rebuilt the entire consumer
						real estate experience and made buying and selling possible on a mobile
						device.
					</p>
				</div>
			</div>
