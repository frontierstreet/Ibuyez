...
const Process = () => {
  return (
    <div className='md:px-10 shadow-xl bg-white py-20  rounded-[20px] px-4 mt-[50px] 950:my-[100px]  xl:max-w-[1330px] xl:mx-auto'>  
            <div >
              <div className='flex flex-col max-w-[643px] gap-3 mb-10'>
                <h3 className='md:text-[60px] flex-1 md:leading-[40px] uppercase  950:text-[55px] 950:leading-[70px] text-[30.04px] leading-[49.24px] text-black font-normal'>
                    Get Sold NOW. ALL CASH. NO HASSLE
                </h3>
                <p className='text-normal flex-1 text-[16px] leading-[28.03px] md:text-[18px] md:leading-[32px] 950:text-[20px] 950:leading-[38.4px]'>
                   When you work with us, you can explore the market knowing you already 
                   have an offer on your home. 
                </p>
               </div>
               <div className=' flex flex-col md:flex-row items-center gap-5 md:gap-10 w-[100%]'>
                ...
                <div className=' bg-white flex-1 border px-5 py-6 rounded-[20px]'>
