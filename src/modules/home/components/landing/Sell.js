    ...
    <div className='md:px-10 px-4 mt-[50px] 950:mt-[100px] xl:max-w-[1330px] xl:mx-auto'>  
            <div className=' bg-white' >
              ...
              <div className=' flex flex-col md:flex-row items-center gap-5 md:gap-10 w-[100%]'>
                 <img src={houseImg} className='flex-1 md:w-1/2 pointer-events-none' alt="Moving background" />
                  <div className='bg-blue px-5 950:px-20 950:py-10 items-center  mx-auto justify-center rounded-[24px] flex-1 h-[302px] grid grid-cols-2 '>
                    {List.map((item, index) => (
                        <div className='flex items-center gap-3'>
                        <p key={index} className='text-white font-normal text-[16px] md:text-[30px]'>{item}</p>
                         <Arrow/>
