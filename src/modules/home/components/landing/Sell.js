			...
			<div className=" bg-white">
				<div className="flex flex-col md:flex-row items-center gap-4 md:gap-10 mb-5">
					...
					<p className="text-normal flex-1 text-[16px] mt-2 leading-[28.03px] md:text-[18px] md:leading-[32px] 950:text-[32px] 950:leading-[38.4px]">
						We cut out the unnecessary steps to make selling your home easy, fast, and
						stress-free.
					</p>
				</div>
				<div className=" flex flex-col md:flex-row items-center gap-5 md:gap-10 w-[100%]">
					...
					<div className="bg-blue px-5 py-10 950:px-20 950:py-10 items-center  mx-auto justify-center rounded-[24px] gap-y-5 flex-1 w-[100%] md:h-[302px] grid grid-cols-2 ">
						{List.map((item, index) => (
							<div className="flex items-center gap-10" key={index}>
								<p
									key={index}
									className="text-white font-normal text-[16px] md:text-[20px]">
									{item}
								</p>
								{/* <Arrow/> */}
							</div>
