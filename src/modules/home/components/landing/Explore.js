...
const Card = ({ icon, header, content, link }) => (
	<div className="bg-white z-30 shadow-lg rounded-[20px] p-6 w-80 text-center">
	  ...
	  <Link to={link} className="inline-block px-4 py-2 border border-[#E5E900] hover:text-black hover:bg-white font-semibold rounded-md hover:bg-[#E5E900] text-black transition duration-300 ease-in-out transform hover:scale-105">
      Learn More
    </Link>
	</div>
  );
