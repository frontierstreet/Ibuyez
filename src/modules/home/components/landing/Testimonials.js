...
const List = [
    {
        id:1,
        testimonial:"I highly recommend IbuyEZ. She was attentive to our needs and worked tirelessly to find us the perfect home. We couldn't be happier with our new place!",
  ...
  return (
    <div className=' flex  flex-col px-5  mt-10 md:flex-row items-center gap-5 950:max-w-[1200px] mx-auto 950:mt-[120px]'>
       <div className='flex-1'>
        <h5 className='font-light text-[20px] text-[#4361EE]'>
          TESTIMONIALS
        </h5>
       ...
       <div className='bg-white shadow-2xl px-4 py-5 950:px-10 950:py-10 items-center max-w-[600px]  mx-auto justify-center rounded-[24px] flex-1  '>
        {List.map((item, index) => (
           <div key={index} className='flex flex-col gap-3'>
            <Arrow/>
             <p className=' font-normal text-[20px] border-b-2  py-4 950:text-[30px]'>{item.testimonial}</p>
